...
const file_v1_example_proto_rawDesc = "" +
	...
	"\fdisplay_name\x18\a \x01(\tR\vdisplayName\x12\x14\n" +
	"\x05email\x18\b \x01(\tR\x05email\x120\n" +
	"\aan_enum\x18\t \x01(\x0e2\x17.examplepb.v1.BasicEnumR\x06anEnum:O\x82\xf7\x02K\x12\x0f\n" +
	"\ttenant_id\x12\x02id\x12\x1a\n" +
	"\ttenant_id\x12\x06idp_id\"\x05\b\x01\x10\x80\b\x12\x1c\n" +
	"\ttenant_id\x12\x06idp_id\x12\aan_enum*\"\n" +
	"\tBasicEnum\x12\t\n" +
