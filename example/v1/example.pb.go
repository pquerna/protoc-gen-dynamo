...
const file_v1_example_proto_rawDesc = "" +
	...
	"\aan_enum\x18\t \x01(\x0e2\x17.examplepb.v1.BasicEnumR\x06anEnum:L\x82\xf7\x02H\x12\x13\n" +
	"\ttenant_id\x12\x02id\"\x02\x10 \x12\x13\n" +
	...
	"\fdisplay_name\x18\a \x01(\tR\vdisplayName\x12\x14\n" +
	"\x05email\x18\b \x01(\tR\x05email\x120\n" +
	"\aan_enum\x18\t \x01(\x0e2\x17.examplepb.v1.BasicEnumR\x06anEnum:W\x82\xf7\x02S\x12\x0f\n" +
	"\ttenant_id\x12\x02id\x12\x1e\n" +
	"\ttenant_id\x12\x06idp_id\x12\x05email\"\x02\x10 \x12 \n" +
	"\ttenant_id\n" +
	"\x06idp_id\x12\aan_enum\"\x02\x10@*\"\n" +
	"\tBasicEnum\x12\t\n" +
